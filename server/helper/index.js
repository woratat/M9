import { getAccountDetailDB, createUserAccountDB, getUserOrEmailAccountDB, getUserAccountDB } from "./account.helper";
...
const helper = {
  account: { getAccountDetailDB, createUserAccountDB, getUserOrEmailAccountDB, getUserAccountDB },
